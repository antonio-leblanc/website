...
function mapInit(){
  ...
  var baseMaps = {
    "<span style='color: red'>NatGeo</span>": NatGeo,
    "Topo": topoLayer,
    "Dark":Dark,
    "ArcGgis":ArcGis
  };
  ...
  var places = raw_places.map(item => L.marker([item.lat, item.lon], {icon:greenIcon}).bindPopup(item.name))
  ...
  var location_json  = './polarsteps_data/locations';
  var json = require([location_json], function(module){
